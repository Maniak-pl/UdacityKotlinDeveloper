package pl.maniak.developer.ui.udacity.color
...
import pl.maniak.developer.databinding.FragmentColorMyViewsBinding

class ColorMyViewsFragment : Fragment() {

    private lateinit var binding: FragmentColorMyViewsBinding
